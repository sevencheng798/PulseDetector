...
// A flag that indicate to Hardware type. 
// The value is 0x02 for hp and 0x03 for ZG before change.
#define  MCU_Hardware_Version                    0x04
#define  MCU_Hardware_HP                         0x02
#define  MCU_Hardware_ZG                         0x03
#define  MCU_Firmware_Version                    0x03
...
// Probe sensor.
#define  MCU_Get_Sensor_Type                     0xA2
#define  MCU_Probe_Sensor_Response_ACK           0xA4
#define  MCU_Probe_Sensor_Response_NACK          0xA8
  #define  MCU_Probe_Sensor_HP                   0x02
  #define  MCU_Probe_Sensor_ZG                   0x03
  #define  MCU_Probe_Sensor_UNKNOW               0xff

#define  MCU_Lock_Flash                          0xB0
#define  MCU_Unlock_Flash                        0xB2

#define  MCU_Set_Serial_Number                   0xc2
#define  MCU_Set_SN_Response_ACK                 0xc4
#define  MCU_Set_SN_Response_NACK                0xc8

#define  LED1_ON()   gd_led1_sda_write(0)
#define  LED1_OFF()  gd_led1_sda_write(1)
...
typedef struct
{
    ...
    uint8_t ucPulseFrameData[16];                /*!< The frame data. */
}PulseCMDFrame;
