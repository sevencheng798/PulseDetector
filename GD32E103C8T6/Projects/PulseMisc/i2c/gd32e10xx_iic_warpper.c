...
#define IIC_SCL_GPIO_PORT                   GPIOA       //GPIO_B
#define IIC_SCL_GPIO_CLK                    RCU_GPIOA

#define IIC_SDA_PIN                         GPIO_PIN_10  //GPIO_PIN_7
#define IIC_SDA_GPIO_PORT                   GPIOA
#define IIC_SDA_GPIO_CLK                    RCU_GPIOA
...
static void iic_soft_init() {
    ...
    /* connect PIN to I2C0_SDA */	
    gpio_bit_set(IIC_SDA_GPIO_PORT, IIC_SDA_PIN);   // IIC IDLE
    /* connect PIN to I2C0_SCL */
    gpio_bit_set(IIC_SCL_GPIO_PORT, IIC_SCL_PIN);   // IIC IDLE
